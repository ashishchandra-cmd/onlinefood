# Generated by Django 3.0.4 on 2020-09-04 07:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(max_length=30)),
                ('vendor_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vendorapp.VendorRegistrationModel')),
            ],
        ),
        migrations.CreateModel(
            name='FoodItemsModel',
            fields=[
                ...
                ('food_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vendorapp.FoodTypeModel')),
            ],
        ),
    ]
